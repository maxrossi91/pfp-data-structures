...
// BENCHMARK_CAPTURE(BM_sdsl_sa, einstein_en, std::string("../../../data/piazzachili/repcorpus/real/einstein.en.txt"))->Arg(10000);
// BENCHMARK_CAPTURE(BM_sdsl_sa, world_leaders, std::string("../../../data/piazzachili/repcorpus/real/world_leaders"))->Arg(10000);
// BENCHMARK_CAPTURE(BM_sdsl_sa, cere, std::string("../../../data/piazzachili/repcorpus/real/cere"))->Arg(10000);
...
// BENCHMARK_CAPTURE(BM_pfp_sa, einstein_en, std::string("../../../data/piazzachili/repcorpus/real/einstein.en.txt"))->Arg(10000);
// BENCHMARK_CAPTURE(BM_pfp_sa, world_leaders, std::string("../../../data/piazzachili/repcorpus/real/world_leaders"))->Arg(10000);
// BENCHMARK_CAPTURE(BM_pfp_sa, cere, std::string("../../../data/piazzachili/repcorpus/real/cere"))->Arg(10000);
...
// BENCHMARK_CAPTURE(BM_sdsl_lcp, einstein_en, std::string("../../../data/piazzachili/repcorpus/real/einstein.en.txt"))->Arg(10000);
// BENCHMARK_CAPTURE(BM_sdsl_lcp, world_leaders, std::string("../../../data/piazzachili/repcorpus/real/world_leaders"))->Arg(10000);
// BENCHMARK_CAPTURE(BM_sdsl_lcp, cere, std::string("../../../data/piazzachili/repcorpus/real/cere"))->Arg(10000);
...
// BENCHMARK_CAPTURE(BM_pfp_lcp, einstein_en, std::string("../../../data/piazzachili/repcorpus/real/einstein.en.txt"))->Arg(10000);
// BENCHMARK_CAPTURE(BM_pfp_lcp, world_leaders, std::string("../../../data/piazzachili/repcorpus/real/world_leaders"))->Arg(10000);
// BENCHMARK_CAPTURE(BM_pfp_lcp, cere, std::string("../../../data/piazzachili/repcorpus/real/cere"))->Arg(10000);
